...
In this exercise, we're going to revisit the angular tea shopping cart and create a custom directive to graphicaly display the amount of caffeine in each tea.
